...
describe('shopReducer', () => {
    ...
    it('should set isFetching to true if FETCH_COLLECTIONS_START', () => {
    ...
    it('should set isFetching to false and collections to payload if fetchingCollectionsSuccess', () => {
        ...
        expect(
            shopReducer(initialState, { 
                ...
                payload: mockItems 
            })).toEqual({ ...initialState, isFetching: false, collections: mockItems });
    });
    ...
    it('should set isFetching to false and errorMessage to payload if fetchingCollectionsFailure', () => {
        ...
        expect(
            ...
            })).toEqual({ ...initialState, isFetching: false, errorMessage: 'an error has occurred' });
    });
});